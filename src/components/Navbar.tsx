...
export default function Navbar() {
    ...
    return (
        <>
            <header className="fixed bg-white w-full z-50 px-8 md:px-44 py-4 flex justify-between transition-[padding,box-shadow] duration-700">
            ...
            <div className={`fixed bg-white w-48 h-full top-0 right-0 z-50 transition-transform duration-700 transform ${open ? 'translate-x-0' : 'translate-x-full'}`}>
